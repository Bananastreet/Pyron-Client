...
object Text {
    ...
    fun InterfaceBuilder.text(builder: TextComponent.() -> Unit) {
        ...
        addText(bld.componentId, bld.text, RSInterface.newFonts, bld.type.id, bld.color, bld.center, bld.shadow,bld.lineSpace,bld.width,bld.tooltips,bld.hover)
        children.add(bld)
    }

    fun InterfaceBuilder.text(component : TextComponent) {
        component.componentId = nextId()
        addText(component.componentId, component.text, RSInterface.newFonts, component.type.id, component.color, component.center, component.shadow, component.lineSpace, component.width,component.tooltips,component.hover)
    ...
    fun addText(id: Int, text: String, tda: Array<RSFont>, idx: Int, color: Int, center: Boolean, shadow: Boolean, lineSpace: Int, width: Int, tooltips: List<String>, hover: Int) {
        RSInterface.interfaceCache[id] = RSInterface()
        val tab = RSInterface.interfaceCache[id]
        tab.parentID = id
        tab.id = id
