...
public enum PlayerRights {
    ...
    public static final EnumSet[] DISPLAY_GROUPS = {
            EnumSet.of(HELPER, MODERATOR, ADMINISTRATOR, GAME_DEVELOPER, OWNER, UNKNOWN, SAPPHIRE_DONATOR, EMERALD_DONATOR,
                    RUBY_DONATOR, DIAMOND_DONATOR, ONYX_DONATOR, ZENYTE_DONATOR, DIVINE_DONATOR, YOUTUBER),
