...
//		}
		switch (i) {
			...
			case 36201: // Raids 1 lobby entrance
				...
				break;
			case 36062:
				objectDef.description = "Teleports you anywhere around Nexus.";
			...
			case 4142:
				...
				objectDef.actions = new String[] { "AFK-Chop", null, null, null, null };
				break;
			case 2816:
				objectDef.name = "Afk Rock";
				objectDef.actions = new String[] { "AFK-Mine", null, null, null, null };
				break;
			case 29771:
			...
			case 33016:
				...
				break;
			case 40461:
				objectDef.name = "Corrupted Portal";
				objectDef.actions = new String[] { "Teleport", null, null, null, null };
				break;
			case 33223:
			...
			case 39238:
				objectDef.actions = new String[] { null, "Bank", "Trading Post", null, null };
				break;
			...
			case 31624:
				...
				break;
			case 29064:
				objectDef.name = "Nexus Leaderboards";
			...
			case 13681:
				...
				break;
			case 30720:
				objectDef.name = "Ambiguous Chest";
				objectDef.actions = new String[] { "Open", "Check", null, null, null };
				break;
			case 34662:
			...
			case 1752:
				...
				objectDef.recolorToReplace = new int[] { 7056, 6674, };
			...
			case 11700:
				...
				objectDef.recolorToReplace = new int[] { 31636 };
			...
			case 10583:
				objectDef.actions = new String[] { "Bank", null, "Trading Post", null, null };
				break;

			case 35965:
				objectDef.name = "Teleport Platform";
				objectDef.actions = new String[] { "Teleport", "Last Teleport", null, null, null };
				break;
		}
