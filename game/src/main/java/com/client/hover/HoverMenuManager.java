...
public class HoverMenuManager {
    ...
    public static void init() {
        ...
        menus.put(6806, new HoverMenu("When used with the ring of Pyron +12% droprate bonus."));//runerogue imbue scroll
        ...
        menus.put(30022, new HoverMenu("The most powerful pet on Pyron."));//Kratos
        menus.put(30122, new HoverMenu("The most powerful pet on Pyron."));//Dark Kratos
        ...
        System.out.println("Pyron has loaded " + menus.size() + "x menu hovers.");
    }
