...
public class RSInterface {
	...
	public static final int TYPE_BACKGROUND = 51;
	public static final int TYPE_DIVIDER = 52;

	public static final int TYPE_TOOLTIP = 53;
	public static final int TYPE_BUTTON = 54;
	public static final int TYPE_RASTERIZER = 55;
