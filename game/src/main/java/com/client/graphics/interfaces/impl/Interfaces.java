...
public final class Interfaces extends RSInterface {
	...
	public static void loadInterfaces() {
		...
		SigilsInterface.build(defaultTextDrawingAreas);
		PerkInterface.build(defaultTextDrawingAreas);
		BPInterface.build(defaultTextDrawingAreas);
		UpgradeInterface.build(defaultTextDrawingAreas);
		staffSpecialBar();
		...
		WogwInterface.get().load(defaultTextDrawingAreas);
	...
	public static void equipmentScreen(TextDrawingArea[] wid) {
		...
		tab.child2(24, 1649, 26 + 22 + 297 - xOff2 - 2, 110 - 44 + 118 - 13 + 8 + yOff);
		tab.child2(25, 1650, 321 - xOff2 + 22, 58 + 157 + yOff);
		tab.child2(26, 1651, 321 - xOff2 + 134, 58 + 121 + yOff);
		tab.child2(27, 1652, 321 - xOff2 + 134, 58 + 157 + yOff);
...
interfaceId+=5000;
	...
	public static void helpComponent(TextDrawingArea[] tda) {
		...
		addInputField(59527, 200, 0xFF981F, "Describe the issue you are having. (200 characters max)", 430, 28, false,
				false, "[A-Za-z0-9 .,]");
